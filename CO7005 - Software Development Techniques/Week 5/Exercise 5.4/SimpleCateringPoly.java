...
public class SimpleCateringPoly {
    public static void main(String[] args) {
		...
		DrinkPoly myDrink = new DrinkPoly(drinkName, drinkPrice, drinkCalories, drinkQuantity, drinkIsFizzy);
		...
		SandwichPoly mySandwich = new SandwichPoly(sandwichName, sandwichPrice, sandwichCalories, sandwichQuantity, (short) 2, (short) 3, true, true);
		...
		SnackPoly mySnack = new SnackPoly(snackName, snackPrice, snackCalories, snackQuantity, snackSize);
		...
		System.out.println("\tDrink type: " + (myDrink.IsFizzy() ? "Fizzy" : "Not Fizzy"));
		myDrink.consume();
		System.out.println();
